...
public class TwitterModel2Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TwitterModel2Package.XOR: {
				...
				if (result == null) result = caseExpBinaire(xor);
				if (result == null) result = caseExpression(xor);
				if (result == null) result = caseStatement(xor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case TwitterModel2Package.EQUAL: {
				...
				if (result == null) result = caseOpBool(equal);
				if (result == null) result = caseExpBinaire(equal);
			...
			case TwitterModel2Package.SUP_EGAL: {
				SupEgal supEgal = (SupEgal)theEObject;
				T result = caseSupEgal(supEgal);
				if (result == null) result = caseOpBool(supEgal);
				if (result == null) result = caseExpBinaire(supEgal);
				if (result == null) result = caseExpression(supEgal);
				if (result == null) result = caseStatement(supEgal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sup Egal</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sup Egal</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSupEgal(SupEgal object) {
		return null;
	}
