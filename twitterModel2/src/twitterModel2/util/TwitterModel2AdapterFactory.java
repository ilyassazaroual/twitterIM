...
public class TwitterModel2AdapterFactory extends AdapterFactoryImpl {
	...
	protected TwitterModel2Switch<Adapter> modelSwitch =
		new TwitterModel2Switch<Adapter>() {
			...
			@Override
			public Adapter caseSupEgal(SupEgal object) {
				return createSupEgalAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link twitterModel2.Equal <em>Equal</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link twitterModel2.SupEgal <em>Sup Egal</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
