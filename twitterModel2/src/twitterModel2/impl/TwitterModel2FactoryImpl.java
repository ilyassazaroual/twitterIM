...
public class TwitterModel2FactoryImpl extends EFactoryImpl implements TwitterModel2Factory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case TwitterModel2Package.EQUAL: return createEqual();
			case TwitterModel2Package.SUP_EGAL: return createSupEgal();
	 ...
	 * @generated
	 */
	public SupEgal createSupEgal() {
		SupEgalImpl supEgal = new SupEgalImpl();
		return supEgal;
	}
