 ...
 * </p>
 * <ul>
 *   <li>{@link twitterModel2.impl.ProgramImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program {
	...
	protected EClass eStaticClass() {
		return TwitterModel2Package.Literals.PROGRAM;
	}
	...
	public EList<Statement> getStatement() {
		if (statement == null) {
			statement = new EObjectContainmentEList<Statement>(Statement.class, this, TwitterModel2Package.PROGRAM__STATEMENT);
		}
		return statement;
	}
