		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTweets_userAccess().getGroup_2(), "rule__Tweets_user__Group_2__0");
					put(grammarAccess.getTweets_userAccess().getGroup_2_1(), "rule__Tweets_user__Group_2_1__0");
					put(grammarAccess.getTweets_locationAccess().getGroup(), "rule__Tweets_location__Group__0");
					put(grammarAccess.getTweets_locationAccess().getGroup_2(), "rule__Tweets_location__Group_2__0");
					put(grammarAccess.getTweets_locationAccess().getGroup_2_1(), "rule__Tweets_location__Group_2_1__0");
					put(grammarAccess.getTweets_entityAccess().getGroup(), "rule__Tweets_entity__Group__0");
					put(grammarAccess.getTweets_entityAccess().getGroup_2(), "rule__Tweets_entity__Group_2__0");
					put(grammarAccess.getTweets_entityAccess().getGroup_2_1(), "rule__Tweets_entity__Group_2_1__0");
					put(grammarAccess.getTweets_dateAccess().getGroup(), "rule__Tweets_date__Group__0");
					put(grammarAccess.getTweets_dateAccess().getGroup_2(), "rule__Tweets_date__Group_2__0");
					put(grammarAccess.getTweets_dateAccess().getGroup_2_1(), "rule__Tweets_date__Group_2_1__0");
					put(grammarAccess.getProportionPositifAccess().getGroup(), "rule__ProportionPositif__Group__0");
					put(grammarAccess.getProportionPositifAccess().getGroup_2(), "rule__ProportionPositif__Group_2__0");
					put(grammarAccess.getProportionPositifAccess().getGroup_2_1(), "rule__ProportionPositif__Group_2_1__0");
					put(grammarAccess.getProportionNegatifAccess().getGroup(), "rule__ProportionNegatif__Group__0");
					put(grammarAccess.getProportionNegatifAccess().getGroup_2(), "rule__ProportionNegatif__Group_2__0");
					put(grammarAccess.getProportionNegatifAccess().getGroup_2_1(), "rule__ProportionNegatif__Group_2_1__0");
					put(grammarAccess.getCountTweetAccess().getGroup(), "rule__CountTweet__Group__0");
					put(grammarAccess.getCountTweetAccess().getGroup_2(), "rule__CountTweet__Group_2__0");
					put(grammarAccess.getCountTweetAccess().getGroup_2_1(), "rule__CountTweet__Group_2_1__0");
					put(grammarAccess.getCountVisitProfilAccess().getGroup(), "rule__CountVisitProfil__Group__0");
					put(grammarAccess.getCountVisitProfilAccess().getGroup_2(), "rule__CountVisitProfil__Group_2__0");
					put(grammarAccess.getCountVisitProfilAccess().getGroup_2_1(), "rule__CountVisitProfil__Group_2_1__0");
					put(grammarAccess.getCroissanceAbonneAccess().getGroup(), "rule__CroissanceAbonne__Group__0");
					put(grammarAccess.getCroissanceAbonneAccess().getGroup_2(), "rule__CroissanceAbonne__Group_2__0");
					put(grammarAccess.getCroissanceAbonneAccess().getGroup_2_1(), "rule__CroissanceAbonne__Group_2_1__0");
					put(grammarAccess.getMoyFollowersAccess().getGroup(), "rule__MoyFollowers__Group__0");
					put(grammarAccess.getMoyFollowersAccess().getGroup_2(), "rule__MoyFollowers__Group_2__0");
					put(grammarAccess.getMoyFollowersAccess().getGroup_2_1(), "rule__MoyFollowers__Group_2_1__0");
					put(grammarAccess.getMoyFavoritedAccess().getGroup(), "rule__MoyFavorited__Group__0");
					put(grammarAccess.getMoyFavoritedAccess().getGroup_2(), "rule__MoyFavorited__Group_2__0");
					put(grammarAccess.getMoyFavoritedAccess().getGroup_2_1(), "rule__MoyFavorited__Group_2_1__0");
					...
					put(grammarAccess.getTweets_userAccess().getArgsAssignment_2_0(), "rule__Tweets_user__ArgsAssignment_2_0");
					put(grammarAccess.getTweets_userAccess().getArgsAssignment_2_1_1(), "rule__Tweets_user__ArgsAssignment_2_1_1");
					put(grammarAccess.getTweets_locationAccess().getArgsAssignment_2_0(), "rule__Tweets_location__ArgsAssignment_2_0");
					put(grammarAccess.getTweets_locationAccess().getArgsAssignment_2_1_1(), "rule__Tweets_location__ArgsAssignment_2_1_1");
					put(grammarAccess.getTweets_entityAccess().getArgsAssignment_2_0(), "rule__Tweets_entity__ArgsAssignment_2_0");
					put(grammarAccess.getTweets_entityAccess().getArgsAssignment_2_1_1(), "rule__Tweets_entity__ArgsAssignment_2_1_1");
					put(grammarAccess.getTweets_dateAccess().getArgsAssignment_2_0(), "rule__Tweets_date__ArgsAssignment_2_0");
					put(grammarAccess.getTweets_dateAccess().getArgsAssignment_2_1_1(), "rule__Tweets_date__ArgsAssignment_2_1_1");
					put(grammarAccess.getProportionPositifAccess().getArgsAssignment_2_0(), "rule__ProportionPositif__ArgsAssignment_2_0");
					put(grammarAccess.getProportionPositifAccess().getArgsAssignment_2_1_1(), "rule__ProportionPositif__ArgsAssignment_2_1_1");
					put(grammarAccess.getProportionNegatifAccess().getArgsAssignment_2_0(), "rule__ProportionNegatif__ArgsAssignment_2_0");
					put(grammarAccess.getProportionNegatifAccess().getArgsAssignment_2_1_1(), "rule__ProportionNegatif__ArgsAssignment_2_1_1");
					put(grammarAccess.getCountTweetAccess().getArgsAssignment_2_0(), "rule__CountTweet__ArgsAssignment_2_0");
					put(grammarAccess.getCountTweetAccess().getArgsAssignment_2_1_1(), "rule__CountTweet__ArgsAssignment_2_1_1");
					put(grammarAccess.getCountVisitProfilAccess().getArgsAssignment_2_0(), "rule__CountVisitProfil__ArgsAssignment_2_0");
					put(grammarAccess.getCountVisitProfilAccess().getArgsAssignment_2_1_1(), "rule__CountVisitProfil__ArgsAssignment_2_1_1");
					put(grammarAccess.getCroissanceAbonneAccess().getArgsAssignment_2_0(), "rule__CroissanceAbonne__ArgsAssignment_2_0");
					put(grammarAccess.getCroissanceAbonneAccess().getArgsAssignment_2_1_1(), "rule__CroissanceAbonne__ArgsAssignment_2_1_1");
					put(grammarAccess.getMoyFollowersAccess().getArgsAssignment_2_0(), "rule__MoyFollowers__ArgsAssignment_2_0");
					put(grammarAccess.getMoyFollowersAccess().getArgsAssignment_2_1_1(), "rule__MoyFollowers__ArgsAssignment_2_1_1");
					put(grammarAccess.getMoyFavoritedAccess().getArgsAssignment_2_0(), "rule__MoyFavorited__ArgsAssignment_2_0");
					put(grammarAccess.getMoyFavoritedAccess().getArgsAssignment_2_1_1(), "rule__MoyFavorited__ArgsAssignment_2_1_1");
